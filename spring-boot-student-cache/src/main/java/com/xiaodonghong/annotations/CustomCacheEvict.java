...
public @interface CustomCacheEvict {
	 ...
	 * @since 4.2
	 * @see #value
	 * @see CustomCacheConfig#cacheNames
	 */
	@AliasFor("value")
	 ...
	 * @see CustomCacheConfig#keyGenerator
	 */
	 ...
	 * @see CustomCacheConfig#cacheManager
	 */
	 ...
	 * to use.
	 * @see CustomCacheConfig#cacheResolver
	 */
